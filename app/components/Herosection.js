      ...
      <div className={styles.container}>
        <div className={styles.grid_two_section}>
          <div className={heroStyles.hero_content}>
            <h1>{title}</h1>
            <p>
              From award-wining drams to blockbuster action movies, we have got you covered. Browse
              our
              selection of latest and greatest movies, and find your new favorite today.
            </p>
            <Link href="/movie">
